...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.winnow_results = function() {
      var escapedSearchText, exactRegex, exact_result, highlightRegex, option, regex, results, results_group, searchText, startpos, text, _i, _len, _ref;
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      this.no_results_temp = new Template(this.get_no_results_html('#{terms}'));
